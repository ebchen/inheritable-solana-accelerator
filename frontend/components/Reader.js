  ...
  render() {
    ...
    return (
      <section className="text-yellow-100  min-h-screen pb-32">
        ...
        <div className="text-sm flex justify-start items-start ml-24">
          <div class="backdrop-sepia-0 backdrop-blur-sm justify-start items-start">
            <div className="flex">
              <p className="text-zinc-500 font-bold text-left mr-4">
                Connected Address:{" "}
              </p>
              <span className="text-zinc-300">{this.state.currentWallet}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-zinc-500 font-bold text-left mr-4">
            ...
            <div className="flex justify-left">
              <a
                ...
                target={"_blank"}
              >
                Smart Contract [{HASH_CONTRACT_ADDRESS}]
              </a>
            </div>
