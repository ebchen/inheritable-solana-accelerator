...
const sideChain =
  "https://public3.weavechain.com:443/92f30f0b6be2732cb817c19839b0940c";
...
class Writer extends Component {
        ...
        <div className="font-inter flex">
          ...
          <div className="w-3/4 ">
            <div className="p-8 mx-auto backdrop-sepia-0 text-yellow-100  min-h-screen">
              <h1 className="mx-auto text-left pb-2 text-5xl font-DMSerif font-extrabold text-yellow-100">
                Sign Will
              </h1>

              <div className="border border-white mt-1"></div>
              <br />
              <p className="text-lg font-DMSan font-bold text-left">
                Please follow below steps to sign will:
              </p>
              ...
              {!!rootHash ? (
                <>
                  <div className="flex justify-center flex-col mt-10">
                    <span className="text-center text-xl text-white font-extrabold">
                      Your will has been successfully enscribed.
                    </span>
    ...
    return (
      <div className=" h-full">
        ...
        <div className="font-inter flex">
          ...
          <div className="w-3/4 ">
            <div className="p-8 mx-auto backdrop-sepia-0 text-yellow-100  min-h-screen">
              <h1 className="mx-auto pb-2 font-DMSerif font-extrabold text-yellow-100 text-5xl">
              ...
              <div className="rounded-md  text-gray py-4 flex flex-col items-start m-3 w-3/5">
                <p className="text-l py-2 ">First Witness</p>
                <Form
                  styling="w-full h-8"
                  field={oracle_1}
                  onChangeFunc={(event) =>
                    this.setState({ oracle_1: event.target.value })
                  }
                  placeholder={""}
                />
                ...
                <Form
                  ...
                  field={oracle_2}
                  onChangeFunc={(event) =>
                    this.setState({ oracle_2: event.target.value })
                  }
                  placeholder={""}
                />
                ...
                <Form
                  ...
                  field={oracle_3}
                  onChangeFunc={(event) =>
                    this.setState({ oracle_3: event.target.value })
                  }
                  placeholder={""}
                />
              </div>
            ...
            <div className="p-8 pr-32 mx-auto backdrop-sepia-0 text-yellow-100 min-h-screen">
              ...
              <div className="flex flex-wrap justify-between font-DMSerif font-semibold">
                <Claim
                  ...
                  field3={wallet_1}
                  onChange1={(event) =>
                    this.setState({ claim_1: event.target.value })
                  }
                  onChange2={(event) =>
                    this.setState({ qty_1: event.target.value })
                  }
                  onChange3={(event) =>
                    this.setState({ wallet_1: event.target.value })
                  }
                />
                ...
                <Claim
                  ...
                  field3={wallet_2}
                  onChange1={(event) =>
                    this.setState({ claim_2: event.target.value })
                  }
                  onChange2={(event) =>
                    this.setState({ qty_2: event.target.value })
                  }
                  onChange3={(event) =>
                    this.setState({ wallet_2: event.target.value })
                  }
                />
                ...
                <Claim
                  ...
                  field3={wallet_3}
                  onChange1={(event) =>
                    this.setState({ claim_3: event.target.value })
                  }
                  onChange2={(event) =>
                    this.setState({ qty_3: event.target.value })
                  }
                  onChange3={(event) =>
                    this.setState({ wallet_3: event.target.value })
                  }
                />
                ...
                <Claim
                  ...
                  field3={wallet_4}
                  onChange1={(event) =>
                    this.setState({ claim_4: event.target.value })
                  }
                  onChange2={(event) =>
                    this.setState({ qty_4: event.target.value })
                  }
                  onChange3={(event) =>
                    this.setState({ wallet_4: event.target.value })
                  }
                />
              </div>
  ...
  async login() {
    ...
    const nodeApi = new WeaveHelper.WeaveAPI().create(
      WeaveHelper.getConfig(sideChain, pub, pvk)
    );
    await nodeApi.init();
    console.log(nodeApi);
  ...
  async write() {
    ...
    if (useSolana) {
      ...
      var tdata = new Uint8Array(
        1 + 4 + 4 + o1.length + 4 + o2.length + 4 + o3.length
      );
      ...
      const res = await contract.methods
        .setOracles([oracle_1, oracle_2, oracle_3])
      ...
      if (STORE_AMOUNTS) {
        ...
        const approveRes = await feeToken.methods
          .approve(TOKEN_ADDRESS, sum)
          .send({
            from: account,
            gasPrice: gasPrice,
          });
    ...
    const resDrop = await nodeApi.dropTable(
      session,
      data_collection,
      table,
      WeaveHelper.Options.DROP_FAILSAFE
    );
    //console.log(resDrop)
    const resCreate = await nodeApi.createTable(
      session,
      data_collection,
      table,
      new WeaveHelper.Options.CreateOptions(false, false, layout)
    );
    ...
    const resWrite = await nodeApi.write(
      session,
      data_collection,
      records,
    ...
    //3. check merkle tree
    const resMerkle = await nodeApi.merkleTree(
      session,
      data_collection,
      table,
